      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Jede Bewerbung wird ihrer Kohorte (Tag der Bewerbung) zugeordnet und durch alle Stufen verfolgt — auch wenn Registrierung und Onboarding später passieren. Ein heute gebuchter Termin für ein späteres Datum zählt also schon heute als „Termin gebucht", „wahrgenommen" erst, wenn das Interview tatsächlich gelaufen ist — frische Tage reifen nach. Test-Bewerbungen sind ausgeschlossen.
          </p>
        </div>
