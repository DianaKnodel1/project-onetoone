...
import { ArrowRight, ArrowLeft, MapPin, Home, CheckCircle2 } from "lucide-react";
...
interface Props {
  ...
  // Wohndauer — früher ein eigener Schritt, jetzt hier mit drin.
...
export default function StepAddress({
  street, zipCode, city, setStreet, setZipCode, setCity,
  ...
  const canSubmit =
    !!street.trim() && zipValid && !!city.trim() &&
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="pt-2 space-y-3">
        <p className="text-sm font-medium text-foreground">Wie lange wohnst du dort schon?</p>
        {[
