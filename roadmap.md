...
- [ ] Vor dem ersten Bild-Upload im Baukasten: Migration `supabase/manual-migrations/20260922010000_landing_media_bucket.sql` einspielen (legt Bucket „landing-media" an)
