...
git clone https://github.com/DianaKnodel1/exactly-as-zipped.git /opt/src/portal
...
git clone https://github.com/DianaKnodel1/exactly-as-zipped.git /opt/apps/portal
cd /opt/apps/portal
