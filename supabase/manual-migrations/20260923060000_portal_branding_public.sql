-- Landing-Generator und Mitarbeiterportal verwenden dieselben öffentlichen
-- Marken- und Kontaktdaten. Die Kontakt-E-Mail wird auf Login/Registrierung
-- angezeigt; SMTP-/Absenderdaten bleiben weiterhin privat.
...
SELECT id, name, domain, domain_aliases, primary_color, logo_url,
  ...
  company_signature_url, company_email,
